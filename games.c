...
int main() {
	...
	printf(ANSI_COLOR_GREEN "| 1.0verkill       | 21.nethack        |" ANSI_COLOR_RESET "\n");
	printf(ANSI_COLOR_GREEN "| 2.angband        | 22.ninvaders      |" ANSI_COLOR_RESET "\n");
	printf(ANSI_COLOR_GREEN "| 3.bastet         | 23.nsnake         |" ANSI_COLOR_RESET "\n");
	printf(ANSI_COLOR_GREEN "| 4.brogue         | 24.nudoku         |" ANSI_COLOR_RESET "\n");
	printf(ANSI_COLOR_GREEN "| 5.cavez-of-phear | 25.open-adventure |" ANSI_COLOR_RESET "\n");
	printf(ANSI_COLOR_GREEN "| 6.cboard         | 26.pacman         |" ANSI_COLOR_RESET "\n");
	printf(ANSI_COLOR_GREEN "| 7.curse-of-war   | 27.snake          |" ANSI_COLOR_RESET "\n");
	printf(ANSI_COLOR_GREEN "| 8.dmagnetic      | 28.solitaire      |" ANSI_COLOR_RESET "\n");
	printf(ANSI_COLOR_GREEN "| 9.dopewars       | 29.viletris       |" ANSI_COLOR_RESET "\n");
	printf(ANSI_COLOR_GREEN "| 10.frotz         | 30.exit           |" ANSI_COLOR_RESET "\n");
	printf(ANSI_COLOR_GREEN "| 11.glulxe        |+++++++++++++++++++|" ANSI_COLOR_RESET "\n");
	printf(ANSI_COLOR_GREEN "| 12.gnuchess      |+++++++++++++++++++|" ANSI_COLOR_RESET "\n");
	printf(ANSI_COLOR_GREEN "| 13.gnugo         |+++++++++++++++++++|" ANSI_COLOR_RESET "\n");
	printf(ANSI_COLOR_GREEN "| 14.gnushogi      |+++++++++++++++++++|" ANSI_COLOR_RESET "\n");
	printf(ANSI_COLOR_GREEN "| 15.gnuski        |+++++++++++++++++++|" ANSI_COLOR_RESET "\n");
	printf(ANSI_COLOR_GREEN "| 16.greed         |+++++++++++++++++++|" ANSI_COLOR_RESET "\n");
	printf(ANSI_COLOR_GREEN "| 17.lexter        |+++++++++++++++++++|" ANSI_COLOR_RESET "\n");
	printf(ANSI_COLOR_GREEN "| 18.moon-buggy    |+++++++++++++++++++|" ANSI_COLOR_RESET "\n");
	printf(ANSI_COLOR_GREEN "| 19.moria         |+++++++++++++++++++|" ANSI_COLOR_RESET "\n");
	printf(ANSI_COLOR_GREEN "| 20.myman         |+++++++++++++++++++|" ANSI_COLOR_RESET "\n");
	printf(ANSI_COLOR_CYAN  "========================================" ANSI_COLOR_RESET "\n");
	printf(ANSI_COLOR_RED   "Select your gamee: ");
	scanf("%d", &a);
